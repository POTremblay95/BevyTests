...
impl Plugin for PlanetPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugin(MaterialPlugin::<Planet3dMaterial>::default())
...
fn setup(
    ...
    commands
        ...
        .insert_bundle(MaterialMeshBundle {
            mesh: meshes.add(Mesh::from(PlanetMesh { resolution: 10 })),
            transform: Transform::from_xyz(-2.0, 0.5, 0.0),
            material: materials.add(Planet3dMaterial { color: Color::RED }),
            ..default()
        })
        .insert(Wireframe);
    commands
        .spawn()
        .insert_bundle(MaterialMeshBundle {
            mesh: meshes.add(Mesh::from(PlanetMesh { resolution: 20 })),
    ...
    commands
        .spawn()
        .insert_bundle(MaterialMeshBundle {
            mesh: meshes.add(Mesh::from(PlanetMesh { resolution: 40 })),
            transform: Transform::from_xyz(2.0, 0.5, 0.0),
            material: materials.add(Planet3dMaterial { color: Color::RED }),
            ..default()
        })
